...
export default function Community() {
  ...
  return (
    <section
      id="community"
      className="relative overflow-hidden py-20 bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-indigo-900"
    >
