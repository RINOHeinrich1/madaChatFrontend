      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
            Faites partie de la révolution des chatbots IA. Contribuez, apprenez et innovez avec nous.
          </p>
        </div>
            ...
            <div className="bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-gray-900 dark:to-indigo-900 rounded-3xl p-8 border border-white/20 dark:border-gray-700/50">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-800 dark:text-gray-200">Basé à</h4>
                    <p className="text-gray-600 dark:text-gray-400">Madagascar</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-800 dark:text-gray-200">Communauté</h4>
                    <p className="text-gray-600 dark:text-gray-400">150+ développeurs actifs</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl p-8 border border-white/20 dark:border-gray-700/50 shadow-lg">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 p-4 bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-gray-900 dark:to-indigo-900 rounded-xl">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-800 dark:text-gray-200">Contribuez sur GitHub</h4>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Participez au développement</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 p-4 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-gray-900 dark:to-purple-900 rounded-xl">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-800 dark:text-gray-200">Rejoignez Discord</h4>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Échangez avec la communauté</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 p-4 bg-gradient-to-r from-green-50 to-teal-50 dark:from-gray-900 dark:to-green-900 rounded-xl">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-800 dark:text-gray-200">Partagez vos projets</h4>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Montrez vos créations</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-8">
            <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-3xl p-8 text-white shadow-2xl">
              ...
              <p className="text-lg mb-8 text-indigo-100">
                Rejoignez notre communauté de développeurs passionnés et créez des chatbots IA révolutionnaires.
              </p>
              ...
              <div className="space-y-4">
                ...
                <button className="w-full bg-indigo-700 hover:bg-indigo-800 text-white px-8 py-4 rounded-xl font-semibold transition-colors duration-300">
            ...
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl p-8 border border-white/20 dark:border-gray-700/50 shadow-lg">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                Démocratiser l'accès à l'intelligence artificielle conversationnelle en créant des outils 
                open source accessibles à tous les développeurs, peu importe leur niveau d'expertise.
              </p>
